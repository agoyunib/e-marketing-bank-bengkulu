...
@section('sidebar-menu')
    @include('backend/pimpinan/sidebar')
@endsection
@section('content')
    <section class="panel" style="margin-bottom:20px;">
        ...
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                <div class="col-md-12">Selamat datang <strong> {{ Session::get('nm_dosen') }} </strong> di halaman Dashboard Pimpinan <b> E-Marketing Bank Bengkulu</b></div>
            </div>
        </div>
    </section>
